...
namespace Reader
{
    ...
    public class ReaderMethod
    {
        ...
        // Codifico para enviar mensaje (consulta)
        ...
        // cmd_set_work_antenna CMD 0x74 len 0x04
        ...
        // cmd_get_output_power CMD 0x77 len 0x04
        ...
        // cmd_set_output_power CMD 0x76 len 0x04
        ...
        // cmd_read 0x81 - Lee la tarjeta (recibe el objeto ReaderSetting.btReadId, el banco de memoria a leer, el tamaño de la palabra y el largo
        public int ReadTag(byte btReadId, byte btMemBank, byte btWordAdd, byte btWordCnt)
        {
            ...
            // Lo manda y guarda el resultado en nResult para devolverlo
            int nResult = SendMessage(btReadId, btCmd, btAryData);

            return nResult;
        }

        // 0x82 Graba lo que le pidas. (objeto readerSetting.btReadId, password (byte), memoria del banco (byte), address inicial 02, largo de la palabra (8) x 2 = 16, texto a escribir)
        public int WriteTag(byte btReadId, byte[] btAryPassWord, byte btMemBank, byte btWordAdd, byte btWordCnt, byte[] btAryData)
        {
            ...
            // Le paso el sujeto, lo que hacer con él array con los datos
        ...
        // Recibe: (objeto , 0x00 (set EPC match), largo del EPC (12) 96 bits, el EPC en formato Byte)
