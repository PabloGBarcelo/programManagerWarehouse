...
namespace Reader
{
    public class MessageTran
    {
        ...
        private byte btReadId;         //dirección del lector
        private byte btCmd;            //数据包命令代码
        private byte[] btAryData;      //Parámetros de comando de paquetes，部分命令无参数
        private byte btCheck;          //Suma de comprobación，除校验和本身外所有字节的校验和
